                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        include 'config.php';
                                        $no=1;
                                        $query = mysqli_query($koneksi, "SELECT * FROM mitra");
                                        ...
                                        ?>                             
                                           <tr>
                                            ...
                                            <td><span class="badge badge-primary"><?php echo $data['status'] ?></td>
                                            <td><a class  ="btn btn-xs btn-success btn-block" href="tambahmitra.php"><i class="nav-icon fa-solid fa-plus"></i></a>
                                            <a class ="btn btn-primary btn-block" href="editmitra.php?id_mitra=<?php echo $data['id_mitra'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <a class="btn btn-danger btn-block" href="mitra.php?id_mitra=<?php echo $data['id_mitra']; ?>&pesan=hapus" onClick ="return confirm ('Apakah data yang anda pilih akan di hapus')"><i class="fa-solid fa-trash"></i></a></td>
