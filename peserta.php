                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        <thead>
                                        <form class="form-inline ml-3" action="peserta.php" method="POST"></form>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Peserta</th>
                                                <th>Nama Peserta</th>
                                                <th>Email</th>
                                                <th>Workshop Diikuti</th>
                                                <th>Status</th>
                                                <th>Aksi</th>                                             
                                            </tr>
                                        </thead>
                                        ...
                                        ?>                             
                                           <tr>
                                            ...
                                            <td><?php echo $data['workshop_diikuti'] ?></td>                                          
                                            <td><span class="badge badge-success"><?php echo $data['status'] ?></td>                                    
                                            <td><a class  ="btn btn-xs btn-success btn-block" href="tambahpeserta.php"><i class="nav-icon fa-solid fa-plus"></i></a>
                                            <a class ="btn btn-primary btn-block" href="editpeserta.php?id_peserta=<?php echo $data['id_peserta'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <a class="btn btn-danger btn-block" href="peserta.php?id_peserta=<?php echo $data['id_peserta']; ?>&pesan=hapus" onClick ="return confirm ('Apakah data yang anda pilih akan di hapus')"><i class="fa-solid fa-trash"></i></a></td>
