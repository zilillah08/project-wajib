                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th> 1</th>
                                                <td>Desain UI/UX Dasar	</td>
                                                <td>10 Okt 2023	</td>
                                                <td>offline</td>
                                                <td><span class="badge badge-success">selesai</span>
                                                </td>
                                                <td>Dasar Desain UI</td>
                                                <td class="color-success">Lihat Detail <p> masuk kelas </p></td>                                                                                         
                                            </tr>
                                            <tr>
                                                <th>2</th>
                                                ...
                                                <td>1 Nov 2023</td>
                                                <td>offline</td>
                                                <td><span class="badge badge-primary">Sedang Diproses</span>
                                                </td>
                                                <td>Panduan Data Science</td>
                                                <td class="color-primary">Lihat Detail <p> masuk kelas </p></td>                                             
                                            ...
                                            <tr>
                                                ...
                                                <td>20 Nov 2023</td>
                                                <td>online</td>
                                                <td><span class="badge badge-danger">Belum Dimulai</span>
                                                </td>
                                                <td>Dasar HTML</td>
                                                <td class="color-danger">Lihat Detail <p> masuk kelas </p></td>                                              
