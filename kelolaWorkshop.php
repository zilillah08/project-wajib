    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboardmitra.php" class="brand-logo">
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                ...
                <?php 
                    ...
                    <li><a class="" href="pembayaranPeserta.php" aria-expanded="false"><i
                                class="fa fa-users"></i><span class="nav-text">Workshop Saya</span></a>
                    </li>
                    <li><a class="" href="pembayaranPeserta.php" aria-expanded="false"><i
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        include 'config.php';
                                        $no=1;
                                        $query = mysqli_query($koneksi, "SELECT * FROM detail_mitra");
                                        while ($data = mysqli_fetch_array($query)) {
                                                    
                                        ?>                             
                                           <tr>
                                            <td><?php echo $no++ ?></td>
                                            <td><?php echo $data['id_detailMitra'] ?></td>
                                            ...
                                            <td><a class ="btn btn-primary btn-block" href="editmitra.php?id_detaiMitra=<?php echo $data['id_detailMitra'] ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                </div>
