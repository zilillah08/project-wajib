                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        <thead>
                                        <form class="form-inline ml-3" action="pegawai.php" method="POST"></form>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Sertifikat</th>
                                                <th>Nama Peserta</th>
                                        ...
                                        ?>                             
                                           <tr>
                                            <td><?php echo $no++ ?></td>
                                            <td><?php echo $data['id_sertifikat'] ?></td>
                                            <td><?php echo $data['nama_peserta'] ?></td>
                                            <td><?php echo $data['nama_workshop'] ?></td>
                                            <td><?php echo $data['tanggal_selesai'] ?></td>
                                            <td><span class="badge badge-primary"><?php echo $data['status_sertifikat'] ?></td>
                                            <td><a class="btn btn-xs btn-success btn-block" href="tambahsertifikat.php"><i class="nav-icon fa-solid fa-plus"></i></a>
                                            <a class ="btn btn-primary btn-block" href="editsertifikat.php?id_sertifikat=<?php echo $data['id_sertifikat'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <a class="btn btn-danger btn-block" href="sertifikat.php?id_sertifikat=<?php echo $data['id_sertifikat']; ?>&pesan=hapus" onClick ="return confirm ('Apakah data yang anda pilih akan di hapus')"><i class="fa-solid fa-trash"></i></a></td>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                </div>
