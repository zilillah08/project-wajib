                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <a href="./profilPeserta.php" class="dropdown-item">
                                        <i class="icon-user"></i>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>Savema Aureliandaru</th>
                                                <td>Bondowoso</td>                                               
                                                <td></td>
                                                <td><a class  ="btn btn-xs btn-success btn-block" href="detailProfilPeserta.php"><i class="fa-regular fa-eye"></i></a>
                                                <a class ="btn btn-primary btn-block" href="editworshop.php?id_workshop=<?php echo $data['id_workshop'] ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
