                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-responsive-sm">
                                        <thead>
                                        <form class="form-inline ml-3" action="workshop.php" method="POST"></form>
                                            <tr>
                                                <th>No</th>
                                                <th>Id Workshop</th>
                                                <th>Nama Workshop</th>
                                        ...
                                        ?>                             
                                           <tr>
                                            ...
                                            <td><a class  ="btn btn-xs btn-success btn-block" href="tambahWorkshop.php"><i class="nav-icon fa-solid fa-plus"></i></a>
                                            <a class ="btn btn-primary btn-block" href="editworshop.php?id_workshop=<?php echo $data['id_workshop'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                                            <a class="btn btn-danger btn-block" href="workshop.php?id_workshop=<?php echo $data['id_workshop']; ?>&pesan=hapus" onClick ="return confirm ('Apakah data yang anda pilih akan di hapus')"><i class="fa-solid fa-trash"></i></a></td>
