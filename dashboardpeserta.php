    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboardpeserta.php" class="brand-logo">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-content d-inline-block">
                                    <div class="stat-text"><i class="fa fa-users"></i> Workshop Diikuti</div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-content d-inline-block">
                                    <div class="stat-text"><i class="fa fa-users"></i> Workshop Selesai</div>
